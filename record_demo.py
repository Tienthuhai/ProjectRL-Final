"""
record_demo.py — Quay video demo agent DQN đã train trên cả 6 map.

Chạy sau khi train_dqn.py hoàn tất và có models/dqn_best.zip.

Output:
  results/videos/demo_<map_name>.mp4  — video riêng cho từng map
  results/videos/demo_all_maps.mp4    — video ghép cả 6 map (nếu có opencv-python)
...
Cách dùng:
  ...
  python record_demo.py --model models/dqn_final.zip   # dùng model khác
"""
